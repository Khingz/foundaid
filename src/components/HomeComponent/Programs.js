    ...
    return (
        <div className="w-screen text-left px-4 flex flex-col items-center justify-center">
            ...
            <div className="flex flex-wrap mt-8 gap-4 justify-center items-stretch">
                <ProgramCard title={'Education for All'} description={'Providing free education to children in rural areas.'} image={image1}/>
                <ProgramCard title={'Healthcare Initiative'} description={'Offering medical camps and preventive care.'} image={image2}/>
                <ProgramCard title={'Community Development'} description={'Building sustainable and self-reliant communities through skill training and entrepreneurship.'} image={image2} />
            </div>
        </div>
    )
}
