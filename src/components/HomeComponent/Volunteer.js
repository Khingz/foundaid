...
const VolunteerSection = () => {
    return(
        <div className="w-screen bg-black text-white flex flex-col gap-4 relative px-2 py-10">
            ...
            <Link to={"/"} className="border px-10 md:py-2 py-2 text-center mx-auto">Volunteer</Link>
        </div>
    )
}
